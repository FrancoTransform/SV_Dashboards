...
def extract_fund_iii_data():
    """Extract Fund III data in the same format as Fund I"""
    
    workbook_path = "/Users/franco/Documents/SemperVirens/SVA-simran-dash/SemperVirens Fund III Workbook - 2025.12.31.xlsx"
    
    print("="*80)
    print("Extracting Fund III Data")
    print("="*80)
    ...
    for idx, row in perf_df.iterrows():
        ...
        investment = {
            ...
            "current": {
                ...
                "series": series, # Assuming current is same as entry
                "ownership_percentage": fd_percent
            }
        }
    ...
    # Map Fund III columns to PortfolioTable expected format
    ...
    char_output_path = "/Users/franco/Documents/SemperVirens/SVA-simran-dash/dashboard/src/data/fund_iii_characteristics.json"
    with open(char_output_path, 'w') as f:
        json.dump(characteristics_data, f, indent=2, default=str)
    print(f"✓ Fund III characteristics saved to {char_output_path}")
    ...
    fund_data = {
        "fund_name": "SemperVirens Fund III",
    ...
    # Save to JSON
    output_path = "/Users/franco/Documents/SemperVirens/SVA-simran-dash/dashboard/src/data/fund_iii_data.json"
    with open(output_path, 'w') as f:
        json.dump(fund_data, f, indent=2, default=str)
    
    print(f"\n✓ Fund III data saved to {output_path}")
...
if __name__ == "__main__":
    try:
        fund_data = extract_fund_iii_data()
        print("\n" + "="*80)
        print("✓ Fund III extraction complete!")
        print("="*80)
