...
import allData from '@/public/mart_founder_success.json';
import { CompanyData } from '@/lib/types';

export default function FounderSuccessSampleDataPage() {
  const [selectedCompany, setSelectedCompany] = useState<CompanyData | null>(null);
  const data = allData as CompanyData[];
      ...
      <header className="border-b" style={{ borderColor: '#4a5f73' }}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center space-x-6">
            <a href="/" className="text-white text-sm font-medium hover:text-cyan-400 transition-colors">← Back to Dashboard</a>
          </nav>
        </div>
      </header>
      ...
      <section className="py-12" style={{ background: '#3a4f63' }}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-xl text-gray-300">
            Founder Success Dashboard - Underlying data
          </p>
        </div>
      </section>
